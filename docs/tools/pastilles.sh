...
# pour se lire comme un sélecteur, repris de BodyCount. La langue courante
# est allumée dans le vert de l'application, l'autre éteinte.
#
...
local pt ct bd fd
if [ "$3" = allumee ]; then
  pt='<i></i>'; ct='#F0F4F8'; bd='#1E4A30'; fd='#0C1C13'
else
...
.p i{width:8px;height:8px;border-radius:2px;background:#1ED760;
